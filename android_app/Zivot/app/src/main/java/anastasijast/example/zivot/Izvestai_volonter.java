...
public class Izvestai_volonter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_izvestai_volonter);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : children) {
                    if(ds.child("doKogo").getValue(String.class).equals("Волонтер") && user.equals(ds.child("volonterID").getValue(String.class))){
                        dbUser=FirebaseDatabase.getInstance().getReference("users/"+ds.child("userID").getValue(String.class));
                        dbUser.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                Toast.makeText(Izvestai_volonter.this, "Неуспешно превземање!", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
